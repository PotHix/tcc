...
\subsection{Audio}
%TODO: achar alguma referencia da tag audio
A tag audio foi construída para suprir uma das necessidades multimídia
da internet. Com o crescimento, os conteúdos da internet foram mudando
...
Isso é feito através da tag \textit{<audio>}, que traz uma
...
audio inserido no documento, possibilitando parar, pausar, tocar,
pular entre várias partes do audio e etc.

Um dos problemas que podem ser encontrados com a tag audio é o tipo de
...
facilmente contornado pela implementação atual da tag \textit{audio},
apenas definindo os dois formatos na mesma tag permitindo que o
navegador escolha o arquivo correto para ser executado.

%TODO: continuar esse paragrafo
Essa funcionalidade é muito útil para o desenvolvimento de jogos, pois
...
%TODO: Mostrar o exemplo do "Water" do WebGL
