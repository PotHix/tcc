...
\begin{figure}[H]
  \centering
	...
	Angry Birds {--} utilizando canvas em varias camadas \\
	Fonte: \citeonline{website:angrybirds}
...
\begin{figure}[H]
  \centering
	...
	\footnotesize\hspace{8\baselineskip}
	Logo da empresa Timetrap {--} Utilizando apenas vetores SVG para sua construção \\
	Fonte: \citeonline{website:svgtimetrap}
  \label{img:timetrap}
\end{figure}
...
\begin{figure}[H]
  \centering
	...
	\footnotesize\hspace{8\baselineskip}
	Swarmation {--} Jogo casual simples que utiliza Websockets \\
	Fonte: \citeonline{website:swarmation}
...
\begin{figure}[H]
  \centering
	...
	\footnotesize\hspace{8\baselineskip}
	Offline cache {--} Currency.io utilizando offline cache para
	fazer uma aplicação que ficará disponível mesmo sem acesso a internet. \\
	Fonte: \citeonline{website:currencyio}
  \label{img:currency}
\end{figure}
...
\begin{figure}[H]
  \centering
	...
	\footnotesize\hspace{8\baselineskip}
	Local Storage e Offline cache {--} Aplicação do Gmail que possibilita a leitura dos e-mails offline com as mensagens sincronizadas previamente. \\
	Fonte: \citeonline{website:gmailoffline}
...
\begin{figure}[H]
  \centering
	...
	\footnotesize\hspace{8\baselineskip}
	Plink {--} Jogo feito utilizando Web Audio Api \\
	Fonte: \citeonline{website:plink}
...
\begin{figure}[H]
  \centering
	...
	\footnotesize\hspace{8\baselineskip}
	Modelos 3D {--} Modelos de personagens 3D sendo renderizados com WebGL \\
	Fonte: \citeonline{webglmodel}
...
\begin{figure}[H]
  \centering
	...
	\footnotesize\hspace{8\baselineskip}
	WebGL Water {--} Utilizando o processamento para obter bonitas cenas em 3D \\
	Fonte: \citeonline{website:webglwater}
...
\begin{figure}[H]
  \centering
	...
	\footnotesize\hspace{8\baselineskip}
	Emberwind {--} Utilizando o poder do WebGL para acelerar o processamento \\
	Fonte: \citeonline{website:emberwind}
  \label{img:emberwind}
\end{figure}
