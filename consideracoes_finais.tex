...
negócio, como é o caso da \citeonline{website:impactjs} mencionada
...
\begin{itemize}
    ...
    \item Análise da base de navegadores em uso atualmente para dar
    subsídio aos jogos criados com HTML5. Esse tópico não está coberto
    nesse trabalho pois exige pesquisa com a base de usuários da
    internet atual com estudo de ações para manter os usuários com as
    versões atualizadas dos navegadores, assim fugindo do tema
    principal que aborda a comparação das tecnologias aplicadas.
\end{itemize}
