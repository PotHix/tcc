\section{Comparação com as outras tecnologias utilizadas atualmente}
...
navegadores, o Java disponibilizou um segundo tipo de aplicação,
chamado applet.
...
Conforme \citeonline{blackman2011beginning}, a engine Unity 3D provê
...
Unity é engine relativamente nova para desenvolvimento de jogos e está
...
diferentes plataformas, entre elas o navegador, que utiliza um plugin um
plugin para executa-lo, e a quantidade de instalações do plugin já
ultrapassa 35 milhões \cite{blackman2011beginning}.

É possível exportar jogos para rodar diretamente no navegador, mas
esse não é o único caminho que a Unity fornece, é possível exportar
