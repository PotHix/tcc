...
páginas utilizando a tag \textit{<applet>} HTML passando o arquivo Java em um dos seus
atributos. Com isso o programa java é baixado do servidor e executado
na maquina do cliente pelo navegador, que utiliza um ambiente de
\textit{sandbox}, assim não permitindo ao programa ter total acesso
dentro da maquina do usuário.
