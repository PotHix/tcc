...
Na Figura~\ref{img:chart-performance-timo} criado por \citeonline{performanceria} é
...
O teste foi executado novamente para mostrar o quanto a performance do Javascript evoluiu nesse curto
período de tempo desde o desenvolvimento da pesquisa feita por
\citeonline{performanceria}. O teste será executado utilizando diversos navegadores no seguinte computador:
...
novamente utilizando um Macbook Pro, Processador i7, 4GB de memória RAM com o sistema operacional
...
No caso do hardware uqe é utilizado, o Flash está utilizando OpenGL
...
executa o teste e possui um hardware diferente pode chegar a
...
está apoiando com material é o Facebook possui uma página
dedicada aos desenvolvedores que pretendem criar aplicativos ou jogos
utilizando HTML5 para a rede social. \cite{facebookhtml5}.
...
O Adobe Flash possui a maior fatia dos jogos desenvolvidos para a
...
essa tecnologia é o \citeonline{website:farmville}, que é um jogo
feito para a rede social Facebook e possui uma grande quantidade de
...
jogos, sendo mais utilizado para trabalhos academicos.
...
jogador. Um exemplo desse tipo de jogo é o \citeonline{website:3dbox},
que é um jogo simples de ação e lógica. Outros jogos desenvolvidos com
applets Java e que seguem o mesmo estilo do \citeonline{website:3dbox}
podem ser encontrados em \citeonline{website:freewarejava}.

O Unity é uma tecnologia nova mas está ficando cada vez mais popular e alguns de seus jogos
possuem versão para a web, como é o caso do
\citeonline{website:unitybattlestargalactica}, que é um jogo que reflete a
...
os amigos, assim trazendo cada vez mais jogadores.
Uma lista de jogos desenvolvidos para a web com Unity pode ser visto
em \citeonline{website:unity3dwebgames}.
...
\citeonline{website:waranimals} que foi criado para a rede social
