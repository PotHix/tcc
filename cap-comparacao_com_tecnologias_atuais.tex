...
%TODO: Tentar encontrar algumas bibliografias para cá
...
(Java, Unity3D e Flash) temdem a possuir uma performance melhor em alguns casos
...
feita utiliando uma tecnologia que exige um plugin externo, mas isso acontece
em alguns casos, fazendo com que a aplicação perca um pouco em performance.

Um dos possíveis motivos desse ganho de performance
