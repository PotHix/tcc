...
A \textit{engine} Unity3D é criada pela empresa Unity
\cite{website:unity3dcompany}, sendo esse o principal produto da
empresa. O foco dessa \textit{engine} é facilitar o desenvolvimento de jogos no
...
navegador \cite{website:unity3dwebgames}, o jogador precisa
necessariamente instalar o Unity web player
\cite{website:unity3dwebplayer} para que o jogo seja executado.
...
O Unity editor \cite{website:unity3d} é o editor da engine Unity3D que possibilita toda a
