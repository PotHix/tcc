...
%TODO: Inserir um gráfico de um caso que o Javascript é melhor
...
utilizar essa aceleração. De acordo com os textes feitos por
\citeonline{webglvsstage3d}, os valores são bem parecidos entre várias
plataformas, novamente dependendo do suporte do hardware para a
utilização da aceleração.

Os testes criados por \citeonline{webglvsstage3d} foram executados
...
Como pode ser visto, é possível conseguir a mesma tava de
