...
%TODO: Analisar o comentário do professor e mudar ou não o texto
%[meu ponto de vista: pode-se dizer que hoje em dia HTML5 é um RÓTULO
%utilizado para identificar: (a) um conjunto de recursos adicionais
%obtidos através do navegador, (b) adições à linguagem HTML e © novas
%APIs para serem utilizadas nos scripts das páginas (em grande parte,
%para utilizar estes novos recursos obtidos através dos navegadores).
%Do ponto de vista mais formal, HTML5 refere-se apenas às mudanças
%sintáticas na linguagem.]
